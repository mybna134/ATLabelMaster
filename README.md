...
- W/A/S/D : 向上/左/下/右切换选中的 Detector；未选中时选择左上角 Detector
- R/G/B/P : 将选中 Detector 的颜色设为 Red/Gray/Blue/Purple
- 1/2/3/4/5/O/L : 将选中 Detector 的 class 设为 1/2/3/4/5/Outpost/Base
- +/- : 将选中 Detector 的大小设为 Big/Small
- J/K/N/M : 左上/右上/左下/右下角点；单按切换可见/不可见，连续双按设为不在范围内
- 左键 : 新建一个目标
- 右键 : 删除一个目标
- 中键 : 移动视图
- 滚轮 : 缩放视图
